...
const images = ref<ImageWithWatermark[]>([
  { src: '/img/gallery/gallery1.jpeg', watermark: '/imgsvg/logo.svg' },
  { src: '/img/gallery/gallery2.jpeg', watermark: '/imgsvg/logo.svg' },
  { src: '/img/gallery/gallery3.jpeg', watermark: '/imgsvg/logo.svg' },
  { src: '/img/gallery/gallery4.jpeg', watermark: '/imgsvg/logo.svg' },
  { src: '/img/gallery/gallery5.jpeg', watermark: '/imgsvg/logo.svg' },
  { src: '/img/gallery/gallery6.jpeg', watermark: '/imgsvg/logo.svg' },
  { src: '/img/gallery/gallery7.jpeg', watermark: '/imgsvg/logo.svg' },
  { src: '/img/gallery/gallery8.jpeg', watermark: '/imgsvg/logo.svg' },
  { src: '/img/gallery/gallery9.jpeg', watermark: '/imgsvg/logo.svg' },
