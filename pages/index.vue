...
const images = ref<ImageWithWatermark[]>([
  { src: '/img/gallery/gallery1.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery2.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery3.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery4.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery5.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery6.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery7.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery8.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery9.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery10.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery11.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery12.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery13.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery14.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery15.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery16.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery17.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery18.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery19.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery20.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery21.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery22.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery23.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery24.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery25.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery26.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery27.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery28.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery29.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery30.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery31.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery32.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery33.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery34.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery35.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery36.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery37.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery38.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery39.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery40.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery41.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery42.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery43.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery44.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery45.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery46.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery47.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery48.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery49.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery50.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery51.jpeg', watermark: '/img/svg/logo.svg' },
  { src: '/img/gallery/gallery52.jpeg', watermark: '/img/svg/logo.svg' },
]);
